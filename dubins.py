...
# _PATH_TYPE_MAP = {"LSR": _LSR, "RSL": _RSL}
...
#     start_x = 0.0  # [m]
#     start_y = 0.0  # [m]
#     start_yaw = np.deg2rad(100.0)  # [rad]
...
#     print(path_yaw)
#     #sy
#     linear_length=np.linalg.norm(np.array([end_x, end_y])-np.array([start_x,start_y]))
#     distance_efficiency = sum(lengths)/linear_length
#     print("distance efficiency:",distance_efficiency )
#     cmd_vel = [0.0, 0.0, 0.0]
#     moving_time =[]
...
#                 cmd_vel=[0.1, 0.0, -0.2]
#                 cmd_speed=0.1
#                 moving_time.append(distance/cmd_speed)
#             elif direction=='S':
#                 cmd_vel=[0.1, 0.0, 0.0]
#                 cmd_speed=0.1
#                 moving_time.append(distance/cmd_speed)
...
#         plot_arrow(start_x, start_y, start_yaw,origin_point_plot_style='xg',label='start', fc='g')
#         plot_arrow(end_x, end_y, end_yaw, label='goal')
#         plt.legend()
#         plt.grid(True)
#         plt.axis("equal")
#         plt.show()
